# open-source-onboarding Specification

## Purpose
Define the external-facing onboarding requirements for YNABBankOfDad so new users can understand the project's identity, prerequisites, safety constraints, and first-run workflow before attempting live YNAB transaction posting.
## Requirements
