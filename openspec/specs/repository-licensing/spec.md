...
## Purpose
Define the repository licensing and public-hosting-readiness requirements for YNABBankOfDad so outside users can determine reuse terms and understand that remaining open-source readiness work is about documentation and license clarity rather than platform migration.
## Requirements
