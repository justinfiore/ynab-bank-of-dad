...
- [x] 1.1 Update `build.gradle` with Java 8 / Groovy 2.4-compatible test dependencies for Spock and WireMock.
...
## 4. Add WireMock-backed API integration coverage
...
- [x] 5.2 Update repository documentation to explain the chosen Spock + WireMock test approach and how to run the tests.
